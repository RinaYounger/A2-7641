...
def main():
    ...
    oa_names = ["GAEP100K50M10","GAEP100K80M10","GAEP200K100M10","GAEP200K150M10", "GAEP50K25M2","GAEP50K40M2",
                "GAEP250K50M75"]
    results = ""
    ...
    oa.append(StandardGeneticAlgorithm(100, 50, 10, nnop[0]))
    oa.append(StandardGeneticAlgorithm(100, 80, 10, nnop[1]))
    oa.append(StandardGeneticAlgorithm(200, 100, 10, nnop[2]))
    oa.append(StandardGeneticAlgorithm(200, 150, 10, nnop[3]))
    oa.append(StandardGeneticAlgorithm(50, 25, 2, nnop[4]))
    oa.append(StandardGeneticAlgorithm(50, 40, 2, nnop[5]))
    oa.append(StandardGeneticAlgorithm(225, 50, 75, nnop[6]))
