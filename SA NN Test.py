...
def main():
    ...
    oa_names = ["SAE11C95","SAE11C5","SAE11C3", "SAE9C95","SAE9C5","SAE9C3", "SAE15C95","SAE15C5","SAE15C3"]
    results = ""
    ...
    oa.append(SimulatedAnnealing(1E11, .5, nnop[1]))
    oa.append(SimulatedAnnealing(1E11, .3, nnop[2]))
    oa.append(SimulatedAnnealing(1E9 ,.95, nnop[3]))
    oa.append(SimulatedAnnealing(1E9, .5, nnop[4]))
    oa.append(SimulatedAnnealing(1E9, .3, nnop[5]))
    oa.append(SimulatedAnnealing(1E15, .95, nnop[6]))
    oa.append(SimulatedAnnealing(1E15, .5, nnop[7]))
    oa.append(SimulatedAnnealing(1E15, .3, nnop[8]))
